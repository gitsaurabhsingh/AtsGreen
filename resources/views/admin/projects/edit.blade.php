    ...
    <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" name="slug" id="slug" class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand focus:ring focus:ring-brand focus:ring-opacity-50 px-3 py-2 border" value="{{ old('slug', $project->slug) }}">
        ...
        <div class="border-t border-gray-100 pt-6 mt-6 mb-6">
            ...
            <div class="mb-6">
                ...
                @if($project->brochure)
                    <div class="mt-2 text-xs text-green-600">Current: <a href="{{ Storage::url($project->brochure) }}" target="_blank" class="underline text-brand hover:text-brand-dark">View Brochure</a></div>
                @endif
