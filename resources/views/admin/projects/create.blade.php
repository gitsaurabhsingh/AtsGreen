    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="text" name="project_name" id="project_name" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand focus:ring focus:ring-brand focus:ring-opacity-50 px-3 py-2 border" value="{{ old('project_name') }}">
            ...
            <div>
                ...
                <select name="project_type" id="project_type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand focus:ring focus:ring-brand focus:ring-opacity-50 px-3 py-2 border">
                    ...
                    @foreach($projectTypes as $pt)
                        <option value="{{ $pt->name }}" {{ old('project_type') == $pt->name ? 'selected' : '' }}>{{ $pt->name }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="price_label" id="price_label" placeholder="e.g. ₹ 2.5 Cr*" class="w-full rounded-md border-gray-300 shadow-sm focus:border-brand focus:ring focus:ring-brand focus:ring-opacity-50 px-3 py-2 border" value="{{ old('price_label') }}">
