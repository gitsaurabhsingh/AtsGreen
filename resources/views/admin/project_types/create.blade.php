...
@section('header', 'Add New Project Type')
@section('content')
<div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 max-w-4xl">
    <form action="{{ route('admin.project-types.store') }}" method="POST">
        ...
        <div class="flex justify-end gap-3 mt-8 border-t pt-4">
            ...
            <button type="submit" class="px-4 py-2 bg-brand text-white rounded-md hover:bg-brand-dark transition">Save Project Type</button>
        </div>
    </form>
</div>
@endsection
